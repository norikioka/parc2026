...
# [py3.10互換パッチ 2026-08-05] 本ファイルはHuggingFace lerobot 0.6.0(Apache-2.0)を改変したものです。
# 元々 `from typing import ... Unpack` としていた箇所を、Python 3.10にバックポートされていない
# typing.Unpack(Python 3.11以降で追加)のため typing_extensions からのimportに変更しています。
